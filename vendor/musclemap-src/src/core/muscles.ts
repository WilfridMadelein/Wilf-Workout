...
/** All 24 base muscle identifiers. */
export const BASE_MUSCLES: readonly Muscle[] = [
  'abs', 'adductors','biceps', 'calves', 'chest', 'deltoids', 'feet', 'forearm',
  'gluteal', 'hamstring', 'hands', 'head', 'hip-flexors', 'knees', 'lower-back',
  'obliques', 'quadriceps', 'tibialis', 'trapezius', 'triceps',
  'upper-back', 'rotator-cuff', 'serratus', 'rhomboids',
] as const;

/** All 12 sub-group identifiers. */
...
const ALWAYS_VISIBLE: Set<Muscle> = new Set(['ankles', 'neck']);
